...
export function Hero() {
  ...
  return (
    <div className="relative w-full overflow-hidden flex min-h-[70vh] items-center justify-center bg-background">
      ...
      >
        <motion.div variants={FADE_DOWN_ANIMATION_VARIANTS} className="inline-block mb-4 px-4 py-1.5 rounded-full border border-primary/20 bg-white/50 backdrop-blur-md">
        ...
        <motion.div variants={FADE_DOWN_ANIMATION_VARIANTS} className="mt-10 flex gap-4">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className={cn(
              "px-8 py-4 bg-primary text-white rounded-full font-semibold text-lg shadow-lg shadow-primary/30",
